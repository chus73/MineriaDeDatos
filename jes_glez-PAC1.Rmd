...
>
> Dentro de los objetivos de este proyecto se encuentra el poder
> identificar los movimientos de tráfico con el fin de poder planificar
> y actuar con la suficiente anticipación ante el colapso circulatorio.
>
...
>
> Utilizando la metodología crisp-dm para el desarrollo de proyectos de
> minería de datos, exploraremos las diferentes fases del proyecto a
...
>
> {Introducir dibujo de las fases}
>
> ### Business Understanding
>
> La primera fase del modelo CRISPM-DM comienza con la comprensión del
> negocio y de los objetivos principales del proyecto. En esta fase se
> realiza un plan preliminar necesario para alcanzar el resultado
> esperado.
>
...
> impera en toda la Unión Europea.
>
> ### Data Understanding
>
> Esta fase se busca familiarizarse con la compresión de los datos,
> identificando los problemas de calidad que puedan tener, descubriendo
> información oculta o subconjunto interesantes de datos.
>
...
> tiene que ser en tiempo "quasi" real. Solamente de esta manera se
> tendrá la suficiente antelación como para poder actuar antes de que la
> fotografía registrada esté caducada.
>
...
>
> En cuanto a la calidad del dato, al ser fuentes abiertas vienen con
> una calidad del dato alta.
>
> ### Data Preparation
>
...
> permita asegurar que se cumplen dichos objetivos.
>
> ### Deployment
>
> La creación de un modelo final no es el final de proyecto, más bien
> supone el llegar a un hito dentro de él. De aquí que el CRISP-DM se
> muestre como un conjunto de actividades recursivas.
...
En esta variable nos encontramos con que se ha asignado el carácter "?"
para los valores desconocidos. Para mejorar la interpretabilidad de los
resultados, vamos a cambiar por "desconocido".

```{r}
workclass_levels <- levels(totalData$workclass)
workclass_levels
```

Si nos fijamos, los nombres vienen con un espacio inicial que
aprovecharemos para corregir.

```{r}
workclass_levels <- trimws(workclass_levels)
workclass_levels[1] <- 'Desconocido'
levels(totalData$workclass) <- workclass_levels
levels(totalData$workclass)
```
...
donde se da la mayoría de ingresos superiores a los 50k.
